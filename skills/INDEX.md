...
| Hand-drawn Explainer Styles | `creative/handdrawn-styles.md` | Three separate hand-drawn systems (paper folk / incised silhouette / bio texture): playbooks, construction specs, lexicon, per-family LoRAs, and the handdrawn-alive motion layer | `hyperframes`, `image-gen-usage` |
